Function Install-WindowsFeature-Hyper-V {
  <#
    .SYNOPSIS
    Windows 10 enable optional features
    .DESCRIPTION
    Install:   PowerShell.exe -ExecutionPolicy Bypass -Command .\hyper-v.ps1 -install
    Uninstall: PowerShell.exe -ExecutionPolicy Bypass -Command .\hyper-v.ps1 -uninstall
    Detect:    PowerShell.exe -ExecutionPolicy Bypass -Command .\hyper-v.ps1 -detect
#>
